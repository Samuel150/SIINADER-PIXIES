  ...
  binding$0.SchedulerBinding[dart.mixinOn] = _SchedulerBinding$36BindingBase$36ServicesBinding => class SchedulerBinding extends _SchedulerBinding$36BindingBase$36ServicesBinding {
    ...
    scheduleForcedFrame() {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 811, 12, "() {\r\n      if (debugPrintScheduleFrameStacks)\r\n        debugPrintStack(label: 'scheduleForcedFrame() called. Current phase is $schedulerPhase.');\r\n      return true;\r\n    }()");
      this.window.scheduleFrame();
      this[_hasScheduledFrame] = true;
    }
    scheduleWarmUpFrame() {
      ...
      async.Timer.run(dart.fn(() => {
        if (!dart.test(this[_warmUpFrame])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 846, 14, "_warmUpFrame");
        this.handleBeginFrame(null);
      }, VoidToNull()));
      async.Timer.run(dart.fn(() => {
        if (!dart.test(this[_warmUpFrame])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 850, 14, "_warmUpFrame");
    ...
    get currentFrameTimeStamp() {
      if (!(this[_currentFrameTimeStamp] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 919, 12, "_currentFrameTimeStamp != null");
      return this[_currentFrameTimeStamp];
    }
    get currentSystemFrameTimeStamp() {
      if (!(this[_lastRawTimeStamp] != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 936, 12, "_lastRawTimeStamp != null");
      return this[_lastRawTimeStamp];
    }
    [_handleBeginFrame](rawTimeStamp) {
      if (dart.test(this[_warmUpFrame])) {
        if (!!dart.test(this[_ignoreNextEngineDrawFrame])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 946, 14, "!_ignoreNextEngineDrawFrame");
    ...
    handleBeginFrame(rawTimeStamp) {
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 991, 12, "() {\r\n      _debugFrameNumber += 1;\r\n\r\n      if (debugPrintBeginFrameBanner || debugPrintEndFrameBanner) {\r\n        final StringBuffer frameTimeStampDescription = StringBuffer();\r\n        if (rawTimeStamp != null) {\r\n          _debugDescribeTimeStamp(_currentFrameTimeStamp, frameTimeStampDescription);\r\n        } else {\r\n          frameTimeStampDescription.write('(warm-up frame)');\r\n        }\r\n        _debugBanner = '▄▄▄▄▄▄▄▄ Frame ${_debugFrameNumber.toString().padRight(7)}   ${frameTimeStampDescription.toString().padLeft(18)} ▄▄▄▄▄▄▄▄';\r\n        if (debugPrintBeginFrameBanner)\r\n          debugPrint(_debugBanner);\r\n      }\r\n      return true;\r\n    }()");
      if (!dart.equals(this.schedulerPhase, binding$0.SchedulerPhase.idle)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1008, 12, "schedulerPhase == SchedulerPhase.idle");
    ...
    handleDrawFrame() {
      if (!dart.equals(this[_schedulerPhase], binding$0.SchedulerPhase.midFrameMicrotasks)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1036, 12, "_schedulerPhase == SchedulerPhase.midFrameMicrotasks");
      developer.Timeline.finishSync();
      try {
        ...
        if (!dart.test(dart.fn(() => {
          ...
          return true;
        }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1054, 14, "() {\r\n        if (debugPrintEndFrameBanner)\r\n          debugPrint('▀' * _debugBanner.length);\r\n        _debugBanner = null;\r\n        return true;\r\n      }()");
    ...
    [_invokeFrameCallback](callback, timeStamp, callbackStack) {
      ...
      if (!(callback != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1096, 12, "callback != null");
      if (!(binding$0._FrameCallbackEntry.debugCurrentCallbackStack == null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1097, 12, "_FrameCallbackEntry.debugCurrentCallbackStack == null");
      if (!dart.test(dart.fn(() => {
        binding$0._FrameCallbackEntry.debugCurrentCallbackStack = callbackStack;
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1098, 12, "() {\r\n      _FrameCallbackEntry.debugCurrentCallbackStack = callbackStack;\r\n      return true;\r\n    }()");
      try {
        callback(timeStamp);
      } catch (e) {
        let exception = dart.getThrown(e);
      ...
      if (!dart.test(dart.fn(() => {
        ...
        return true;
      }, VoidTobool())())) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/scheduler/binding.dart", 1120, 12, "() {\r\n      _FrameCallbackEntry.debugCurrentCallbackStack = null;\r\n      return true;\r\n    }()");
    }
  };
  ...
  mouse_tracking.MouseTracker = class MouseTracker extends change_notifier.ChangeNotifier {
    ...
    [_handleEvent](event) {
      ...
      this[_updateDevices]({targetEvent: event, handleUpdatedDevice: dart.fn((mouseState, previousAnnotations) => {
          ...
          mouse_tracking.MouseTracker._dispatchDeviceCallbacks({lastAnnotations: previousAnnotations, nextAnnotations: mouseState.annotations, handledEvent: previousEvent, unhandledEvent: event, trackedAnnotations: this[_trackedAnnotations]});
    ...
    [_updateAllDevices]() {
      this[_updateDevices]({handleUpdatedDevice: dart.fn((mouseState, previousAnnotations) => {
          mouse_tracking.MouseTracker._dispatchDeviceCallbacks({lastAnnotations: previousAnnotations, nextAnnotations: mouseState.annotations, handledEvent: mouseState.latestEvent, unhandledEvent: mouseState.latestEvent, trackedAnnotations: this[_trackedAnnotations]});
        }, _MouseStateAndLinkedHashSetOfMouseTrackerAnnotationToNull())});
    }
    [_updateDevices](opts) {
      ...
      if (targetEvent != null) {
        ...
        if (!(targetState == null)[$_equals](events.PointerAddedEvent.is(targetEvent))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 388, 14, "(targetState == null) == (targetEvent is PointerAddedEvent)");
        if (events.PointerAddedEvent.is(targetEvent)) {
    ...
    static _dispatchDeviceCallbacks(opts) {
      ...
      let handledEvent = opts && 'handledEvent' in opts ? opts.handledEvent : null;
      ...
      if (!(lastAnnotations != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 435, 12, "lastAnnotations != null");
      if (!(nextAnnotations != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 436, 12, "nextAnnotations != null");
      if (!(unhandledEvent != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 438, 12, "unhandledEvent != null");
      if (!(trackedAnnotations != null)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 439, 12, "trackedAnnotations != null");
      ...
      for (let annotation of enteringAnnotations) {
        if (!dart.test(trackedAnnotations.contains(annotation))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 463, 14, "trackedAnnotations.contains(annotation)");
      ...
      if (events.PointerHoverEvent.is(unhandledEvent)) {
        ...
        for (let annotation of hoveringAnnotations) {
          if (!dart.test(trackedAnnotations.contains(annotation))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 478, 16, "trackedAnnotations.contains(annotation)");
          if (!dart.test(lastAnnotations.contains(annotation)) || !events.PointerHoverEvent.is(handledEvent) || !dart.equals(handledEvent.position, unhandledEvent.position)) {
    ...
    schedulePostFrameCheck() {
      if (!dart.test(mouse_tracking.MouseTracker._duringBuildPhase)) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 503, 12, "_duringBuildPhase");
      if (!!dart.test(this[_duringDeviceUpdate])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 504, 12, "!_duringDeviceUpdate");
      if (!dart.test(this[_hasScheduledPostFrameCheck])) {
        ...
        binding$0.SchedulerBinding.instance.addPostFrameCallback(dart.fn(duration => {
          if (!dart.test(this[_hasScheduledPostFrameCheck])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 508, 16, "_hasScheduledPostFrameCheck");
    ...
    attachAnnotation(annotation) {
      if (!!dart.test(this[_duringDeviceUpdate])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 559, 12, "!_duringDeviceUpdate");
      if (!!dart.test(this[_trackedAnnotations].contains(annotation))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 560, 12, "!_trackedAnnotations.contains(annotation)");
      this[_trackedAnnotations].add(annotation);
    }
    detachAnnotation(annotation) {
      if (!!dart.test(this[_duringDeviceUpdate])) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 572, 12, "!_duringDeviceUpdate");
      if (!dart.test(this[_trackedAnnotations].contains(annotation))) dart.assertFailed(null, "org-dartlang-app:///packages/flutter/src/gestures/mouse_tracking.dart", 573, 12, "_trackedAnnotations.contains(annotation)");
