define(['dart_sdk', 'packages/siinader_pixies/main'], function(dart_sdk, packages__siinader_pixies__main) {
  'use strict';
  ...
  const main = packages__siinader_pixies__main.main;
  ...
  dart.trackLibraries("packages/siinader_pixies/main_web_entrypoint", {
    "package:siinader_pixies/main_web_entrypoint.dart": main_web_entrypoint
  }, {
